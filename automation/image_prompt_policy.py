...
LAYFLAT_REFERENCE_PACKAGE='https://navar-abyari.ir/wp-content/uploads/%D9%84%D9%88%D9%87-%D9%86%D8%AE%DB%8C-2-%D8%A7%DB%8C%D9%86%DA%86-1.webp'
...
def image_prompt(item,kind):
    ...
    return (
      ...
      'Do not use a close-up product composition, centered package, studio background, oversized package, duplicate product, floating object, collage, caption, watermark, invented specifications or gibberish label text. '
