...
- آخرین بروزرسانی: `2026-09-26T04:46:16+00:00`
- وضعیت صف: **آماده اجرای بعدی** (`ready`)
- پیشرفت: **1 از 1148 (0.09٪)**
- نمودار پیشرفت: `░░░░░░░░░░░░░░░░░░░░`
- تکمیل‌شده: **1**
- در حال پردازش: **0**
- در انتظار: **1147**
- ناموفق: **0**
- مسدود مدل تصویر: **0**
- میانگین طول مقالات تکمیل‌شده: **1097 کلمه**
...
- عنوان: **آفات و بیماری‌های عدس با آبیاری قطره‌ای**
- شناسه: `crop-002`
- گروه: `crop`
- تعداد تلاش قبلی: **0**
...
- هنوز بسته کاملی آماده نشده است؛ پیشرفت بسته جاری: **1/50 مقاله**.

## خروجی‌های تولیدشده

- فایل JSON مقاله‌ها: **1**
- تصاویر تولیدشده: **3**
- فایل‌های SQL: **1**
- فایل‌های Rollback: **1**
